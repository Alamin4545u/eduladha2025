document.addEventListener('DOMContentLoaded', function() {
    ...
    if (tg.initDataUnsafe && tg.initDataUnsafe.user) {
        ...
        fetchUserData();
        setupEventListeners();
        createSvgWheel(); // হুইল তৈরির ফাংশন কল
    } else {
        document.body.innerHTML = "<h1>অনুগ্রহ করে টেলিগ্রাম অ্যাপ থেকে খুলুন।</h1>";
    }

    // =======================================================
    // === স্পিন হুইল তৈরির আসল ফাংশন এখানে পুনঃস্থাপন করা হলো ===
    // =======================================================
    ...
    async function loadAndDisplayTasks() {
        ...
        try {
            ...
            taskSnapshot.forEach(doc => {
                ...
                taskElement.dataset.taskId = taskId; taskElement.dataset.reward = task.reward;
    ...
    function handleError(message, error) {
        ...
        if (typeof message === 'string') { tg.showAlert(message); } else { console.error("Snapshot Error:", message); tg.showAlert("একটি অপ্রত্যাশিত সমস্যা হয়েছে।"); }
    }
});
